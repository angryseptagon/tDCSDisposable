...
U 1 1 5C6C69D2
P 2950 5350
F 0 "U1" V 2850 5100 50  0000 L CNN
...
U 1 1 5C911C11
P 3150 4200
F 0 "J2" H 3256 4378 50  0000 C CNN
F 1 "Conn_01x02_Male" H 3250 4300 50  0000 C CNN
...
F 1 "+9V" V 1115 4178 50  0000 L CNN
...
U 1 1 5C945459
P 2000 2350
F 0 "R10" V 2207 2350 50  0000 C CNN
F 1 "10 kOhm" V 2116 2350 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 1930 2350 50  0001 C CNN
...
U 1 1 5C9D02B5
P 1400 4050
F 0 "JP1" H 1354 4118 50  0000 L CNN
F 1 "SolderJumper_2_Open" H 1200 4200 50  0000 L CNN
...
U 1 1 5CAA5D32
P 9850 6000
F 0 "#PWR0110" H 9850 5750 50  0001 C CNN
...
U 1 1 5CBE8EE0
P 3850 4200
F 0 "#PWR0111" H 3850 3950 50  0001 C CNN
...
use one schottky footprint only
Text Notes 550  6800 0    50   ~ 0
do not use both battery footprints, \nthese are here for alternate circuit designs
Text Notes 2150 3400 0    50   ~ 0
use only one mosfet, symbols are \nhere for different footprint options
Text Notes 4600 1450 0    50   ~ 0
connect based on whether anode should be \nring or sleeve based on trs connector
Wire Wire Line
	1100 4050 1250 4050
Wire Wire Line
